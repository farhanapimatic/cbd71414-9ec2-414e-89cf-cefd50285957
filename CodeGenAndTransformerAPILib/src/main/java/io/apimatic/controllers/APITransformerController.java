...
public class APITransformerController extends BaseController {    
    ...
    public void usingApikeyAsync(
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5322921786573576736L;
            {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5527747540854933663L;
            {
    ...
    public void usingUrlAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4948362443877390067L;
            {
                    put( "format", (format != null) ? format.value() : null );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4774233045577924406L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
    ...
    public void usingFileAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4807837085308883911L;
            {
                    put( "format", (format != null) ? format.value() : null );
            }});
        //validate and preprocess url
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5389661505831280597L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
        ...
        Map<String, Object> _parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 5440410949816958197L;
            {
                    put( "file", file );
            }
        };
